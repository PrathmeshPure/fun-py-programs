...
googletrans makes it very easy to translate text.
get googletrans by :
...
def main(src, dest, ln):
    ...
    #implemented considering srt files (subtile)
    for line in srcfile:
        wrtline = translator.translate(line, dest=ln).text + "\n"
        destfile.writelines(wrtline)
...
if __name__ == '__main__':
    srcfile = "File1.srt"             #text files are also accepted
    destfile = "File2.srt"
